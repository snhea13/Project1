...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AgentsRejectListPage(employeeId: 12),  // Pass employeeId here
    );
  }
}

class AgentsRejectListPage extends StatefulWidget {
  final int employeeId;

  AgentsRejectListPage({required this.employeeId});

  @override
  _AgentsRejectListPageState createState() => _AgentsRejectListPageState();
}

class _AgentsRejectListPageState extends State<AgentsRejectListPage> {
  ...
  Future<void> _search() async {
    ...
    // Use the passed employeeId in the API request
    final String url =
        'https://employeemanagement.thedigitalindia.com/api/TL_Leave_Portals/Approved_Lists?fromDate=$fromDate&toDate=$toDate&displayLength=10&displayStart=0&sortCol=1&sortDir=asc&userid=${widget.employeeId}&search=';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Rejected Requests for Employee ${widget.employeeId}'),
        leading: IconButton(
