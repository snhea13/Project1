              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                   ...
                   // boxShadow: <BoxShadow>[
                 //     BoxShadow(color: (AppTheme.grey?.withOpacity(0.6))?? Colors.grey.withOpacity(0.6), blurRadius: 24),
                 //      BoxShadow(
                 ...
                 //          blurRadius: 24),
                    boxShadow: [
                      BoxShadow(
                        color: (AppTheme.grey?.withOpacity(0.6)) ?? Colors.grey.withOpacity(0.6),
                        blurRadius: 24.0, // Ensure this is always a double value
                        offset: Offset(0.0, 0.0), // Ensure Offset is not null
                      ),
